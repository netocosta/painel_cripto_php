            ...
            <div id="centro_lista_tabela">
                <table id="dados" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    foreach ($cripto->index() as $crip) {
                        ...
                        $consultaApi = $cripto->consultaApi($crip['api_id']);
                        $image = $consultaApi['image'];
                        $name = $consultaApi['name'];
                        $symbol = $consultaApi['symbol'];
                        $price = (float)$consultaApi['price'];
                        $perc24h = $consultaApi['perc24h'];
                        $color = 'variantGreen';
